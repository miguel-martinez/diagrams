...
/**
 * Structure diagrams question definition class.
 *
 * @package    qtype
 * @subpackage diagrams
...
/**
 * Represents a structure diagrams question.
 *
 * @copyright  2013 Jose Ignacio Hernando García, Miguel Martínez Pañeda
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_diagrams_question extends question_graded_by_strategy
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseenterananswer', 'qtype_diagrams');
    }
    ...
    public function compare_response_with_answer(array $response, question_answer $answer) {
        ...
        return self::compare_string_with_wildcard(
                ...
                //new: $response['answer'], $answer->answer.'#*', !$this->beam);
		//$this->beam se podria eliminar (es el antiguo caseyes/no)
                //y habría que simplificar tambien la funcion 
		// compare_string_with_wildcard 
		// OJO OJO pendiente JIH
		// Debería programarse aqui la función chkEsf del
                // fichero java para poder reevaluar, etc.
		$response['answer'], $answer->answer.'#*', !$this->beam);
    }
